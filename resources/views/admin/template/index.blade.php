    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            {{ Breadcrumbs::render('template.index') }}
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
					  <a class="btn btn-primary btn-sm" href="{{route('template.edit',$t->id)}}"><i class="fas fa-edit"></i></a>
					  <form  action="{{route('users.destroy',$t->id)}}" method="POST" style="display:none">
              @csrf
              @method('DELETE')
          </form>
